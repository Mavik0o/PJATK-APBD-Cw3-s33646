...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        {
            return ["Nie znaleziono przedmiotu z kategorii Analytics."];
        }
    ...
    {
        var istnieje = DaneUczelni.Zapisy.Any(z => !z.CzyAktywny);
    ...
    public IEnumerable<string> Zadanie13_GrupowanieZapisowWedlugPrzedmiotu()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(
                ...
                grupa => grupa.Key,
                przedmiot => przedmiot.Id,
                (grupa, przedmiot) => $"{przedmiot.Nazwa} | liczba zapisów: {grupa.Count()}"
            )
            .OrderBy(w => w);
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(
                ...
                grupa => grupa.Key,
                przedmiot => przedmiot.Id,
                (grupa, przedmiot) => $"{przedmiot.Nazwa} | średnia ocena: {grupa.Average(z => z.OcenaKoncowa!.Value):0.00}"
            )
            .OrderBy(w => w);
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        var wynik = DaneUczelni.Przedmioty
            ...
            .Where(p => !DaneUczelni.Zapisy.Any(z => z.PrzedmiotId == p.Id && z.OcenaKoncowa.HasValue))
            .Select(p => p.Nazwa)
            .ToList();

        return wynik.Count != 0
            ? wynik
            : ["Brak przedmiotów startujących w kwietniu 2026 bez ocen końcowych."];
    }
        ...
        return DaneUczelni.Prowadzacy
            .Select(prowadzacy =>
            {
                var oceny = DaneUczelni.Przedmioty
                    .Where(p => p.ProwadzacyId == prowadzacy.Id)
                    .Join(
                        DaneUczelni.Zapisy.Where(z => z.OcenaKoncowa.HasValue),
                        przedmiot => przedmiot.Id,
                        zapis => zapis.PrzedmiotId,
                ...
                var srednia = oceny.Count > 0
                    ? oceny.Average().ToString("0.00")
                    : "brak ocen";

                return $"{prowadzacy.Imie} {prowadzacy.Nazwisko} | średnia ocen: {srednia}";
            })
            .OrderBy(w => w);
    }
